...
import { Outlet, type ShouldReloadFunctionArgs, useActionData, useLoaderData } from "soseki";
...
export default function About() {
  return (
    <div>
      ...
      <form method="POST" action="/about" data-testid="about-form">
        <button type="submit" data-testid="about-submit">
          送信
        </button>
      </form>
      <a href="/" data-testid="about-tohome">
        Home
      </a>
      <Outlet />
    </div>
